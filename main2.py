...
# -------------------- Insertar cliente --------------------
    print("\n--- Insertar Cliente ---")
    c = Cliente()
    c.SetNombre("Camila Alvarez")
    c.SetDocumento("1414111")
    c.SetTelefono("3111234567")
    c.SetCorreo("Camila@gmail.com")
    c.SetDireccion("Calle 1 #14-24")
...
# -------------------- Actualizar cliente --------------------
    ...
    c_actualizar.SetNombre("Sara Vélez Al")
    c_actualizar.SetTelefono("30000003")
    c_actualizar.SetCorreo("sara.nuevo2@gmail.com")
